...
\\
  ...
  \trans{yA nabiyya al-hudY `alayka \w `timAdI}{O Prophet of guidance, upon you is my reliance}
\\
  \trans{kun ^safI`I fI .gurbatI wa \w nfirAdI}{Be my intercessor in my exile and in my seclusion}
  \trans{sayyamA laylata \w tti.sAlI bi-ramsI}{Particularly at the night of my communion}
\\
  \trans{wa .salATu al-ll_ahi ma`a ta.hiyyati rabbI}{And the prayers of Allah and the greetings of my Lord}
  \trans{tuhdA li-lnabiyyi al-hA^simI wa .sa.hbih}{Are gifted to the Hashimi Prophet and his companions}
\\
  \trans{mA tarannama .tA'ir min fawqa qudsI}{As long as a bird flies in exaltation above the sanctified place}
  \trans{`adada al-kA'inAti min kulli jinsI}{As many as the creatures of every type}
\end{longtable}
